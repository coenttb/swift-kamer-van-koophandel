...
extension DependencyValues.KamerVanKoophandel: DependencyKey {
  public static let testValue: DependencyValues.KamerVanKoophandel = .init(
    baseUrl: URL(string: "https://api.kvk.nl")!
  )
  public static let liveValue: DependencyValues.KamerVanKoophandel = .init(
    baseUrl: URL(string: "https://api.kvk.nl")!
  )
}
